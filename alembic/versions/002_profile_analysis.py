"""add profile_snapshots, github_tokens, github_cache

Revision ID: 002_profile_analysis
Revises: 001_initial
...
revision: str = "002_profile_analysis"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("merged_skills", JSONB, nullable=True),
